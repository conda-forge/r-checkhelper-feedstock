...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-checkhelper-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-checkhelper-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-checkhelper
# for installing globally
pixi global install r-checkhelper
```
...
It is possible to list all of the versions of `r-checkhelper` available on your platform:
...
```
pixi search r-checkhelper --channel conda-forge
```
